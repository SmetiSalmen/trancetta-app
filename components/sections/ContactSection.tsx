  ...
  return (
    <section id="contact" ref={sectionRef} className="section-padding bg-cream-dark overflow-hidden">
      <div className="container-custom">
        ...
        {/* Contact cards */}
        <div ref={cardsRef} className={`grid grid-cols-1 sm:grid-cols-${contactItems.length} gap-5 mb-10`}>
          {contactItems.map((item) => (
            <a
              ...
              className="group bg-white rounded-2xl p-6 border border-cream-dark hover:border-transparent hover:shadow-card-hover transition-all duration-300 hover:-translate-y-1.5 flex flex-col items-center text-center"
            >
              <div
              ...
              <div className="font-poppins text-xs text-text-secondary mb-1 uppercase tracking-wider">{item.label}</div>
              <div className="font-poppins font-semibold text-black-warm text-sm group-hover:text-red-primary transition-colors">
                {item.value}
              </div>
            </a>
          ))}
